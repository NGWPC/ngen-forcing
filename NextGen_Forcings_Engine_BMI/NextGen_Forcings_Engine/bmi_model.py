...
class NWMv3_Forcing_Engine_BMI_model_Base(Bmi):
    ...
    def init_log(self, config_file: str) -> None:
        ...
        LOG.info("-" * 30)
        LOG.info(
            f"BMI Forcing Engine initialized with {config_file}{Pld(St.INITTING, modnm=MODNM)}"
        )
    ...
    def set_initial_time_and_step(self, cat_ids) -> None:
        """Set the initial time, time step, and cat_ids for the model."""
    ...
    def initialize(self) -> None:
        ...
        self.set_initial_time_and_step(cat_ids)
