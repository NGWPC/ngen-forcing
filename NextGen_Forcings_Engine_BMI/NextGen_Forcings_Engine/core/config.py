...
class ConfigOptions:
    ...
    def validate_config(self, cfg_bmi: dict) -> None:
        ...
        try:
            ...
            err_handler.err_out_screen(
                "Improper SuppPcp option specified in configuration file", e
            )
        ...
        try:
            ...
            err_handler.err_out_screen(
                "Unable to locate SubOutFreq in the configuration file.", e
            )
        except configparser.NoOptionError as e:
            err_handler.err_out_screen(
                "Unable to locate SubOutFreq in the configuration file.", e
        ...
        try:
            ...
            err_handler.err_out_screen(
                "Unable to locate ScratchDir in the configuration file.", e
            )
        except configparser.NoOptionError as e:
            err_handler.err_out_screen(
                "Unable to locate ScratchDir in the configuration file.", e
        ...
        try:
            ...
            err_handler.err_out_screen(
                "Unable to locate compressOut in the configuration file.", e
            )
        except configparser.NoOptionError as e:
            err_handler.err_out_screen(
                "Unable to locate compressOut in the configuration file.", e
        ...
        if self.include_lqfrac < 0 or self.include_lqfrac > 1:
            err_handler.err_out_screen(
                "Please choose an includeLQFrac value of 0 or 1."
            )
        ...
        try:
            ...
            err_handler.err_out_screen(
                "Unable to locate AnAFlag in the configuration file.", e
            )
        except configparser.NoOptionError as e:
            err_handler.err_out_screen(
                "Unable to locate AnAFlag in the configuration file.", e
        ...
        try:
            ...
            err_handler.err_out_screen(
                "Unable to locate GRID_TYPE in the configuration file.", e
            )
        except configparser.NoOptionError as e:
            err_handler.err_out_screen(
                "Unable to locate GRID_TYPE in the configuration file.", e
        ...
        if self.grid_type.lower() == "gridded":
            ...
            try:
                ...
                err_handler.err_out_screen(
                    "Unable to locate LONVAR in the configuration file.", e
                )
            except configparser.NoOptionError as e:
                err_handler.err_out_screen(
                    "Unable to locate LONVAR in the configuration file.", e
            ...
            try:
                ...
                err_handler.err_out_screen(
                    "Unable to locate LATVAR in the configuration file.", e
                )
            except configparser.NoOptionError as e:
                err_handler.err_out_screen(
                    "Unable to locate LATVAR in the configuration file.", e
