...
| [#137](https://github.com/NGWPC/ngen-forcing/pull/137) | 2026-04-16 | Refactor GeoMeta and InputForcing + Tests | geoMod.py, forcingInputMod.py | Further refactoring of GeoMeta and InputForcing with accompanying tests. |
