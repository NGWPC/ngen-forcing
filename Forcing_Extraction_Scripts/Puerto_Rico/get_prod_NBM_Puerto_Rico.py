...
def main(args):
    ...
    if os.path.isfile(lockFile):
        ...
        print("ERROR: Another NBM Puerto Rico Fetch Program Running. PID: " + pid + ". Please remove lockfile before attempting to execute another file extraction. Exiting script")
        sys.exit(1)
    else:
