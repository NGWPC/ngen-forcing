...
def main(args):
    ...
    lockFile = os.path.join(outDir, "GET_ARW_PR.lock")
    ...
    if os.path.isfile(lockFile):
        ...
        print(f"ERROR: Another WRF ARW Puerto Rico Fetch Program running - PID: {pid}.  Please remove lockfile at {lockFile} before attempting to execute another file extraction. Exiting script")
        sys.exit(1)
    else:
