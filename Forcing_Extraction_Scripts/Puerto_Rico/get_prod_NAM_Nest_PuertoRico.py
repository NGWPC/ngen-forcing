...
def main(args):
    ...
    pid = os.getpid()
    lockFile = outDir + "/GET_NAM_Nest_PR.lock"
    ...
    if os.path.isfile(lockFile):
        ...
        print("ERROR: Another NAM Nest Puerto Rico Fetch Program Running. PID: " + pid + ". Please remove lockfile before attempting to execute another file extraction. Exiting script")
        sys.exit(1)
    else:
