...
nwm_forcing_coastal() {
  ...
  commandpy="python $USHnwm/wrf_hydro_workflow_dev/forcings/WrfHydroFECPP/workflow_driver.py"

  mkdir -p $COASTAL_FORCING_OUTPUT_DIR

  export FECPP_JOB_INDEX=0
  export FECPP_JOB_COUNT=1
  #${MPICOMMAND2} ${commandpy} >> $DATAlogs/nwm_forcing_${PDY}${cyc}.log 2>&1
  ${MPICOMMAND3} ${commandpy} >> $DATAlogs/nwm_forcing_${PDY}${cyc}.log 2>&1

  echo "FECPP step complete"
